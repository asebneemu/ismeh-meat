import videoKuzuMobile from '../../assets/Pictures/kuzu-background-video-mobile.mp4'; // Kuzu arka plan videosu (mobil)
    ...
    return (
        ...
        >
            <div className="relative w-[80%] mx-4 my-6 p-2 bg-white bg-opacity-50"> {/* Şeffaf beyaz arka planlı dış div */}        
                ...
                >
                    <source src={videoKuzuMobile} type="video/mp4" />
                ...
                <div className="absolute top-0 w-[95%] h-[95%] left-[2.5%] top-[2.5%] bg-black bg-opacity-50 flex flex-col justify-center items-center px-10 pb-10 pt-5 rounded-md">
                    <h1 className="text-white xs:text-4xl xxs:3xl mb-4">Kuzu Et Ürünleri</h1> {/* Başlık */}
...
export default MobilKuzuProducts;
